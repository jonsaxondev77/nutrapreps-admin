...
// The interface now extends standard textarea attributes
...
const TextArea: React.FC<TextareaProps> = ({
  ...
  error = false,
  hint = "",
  ...props // All other props are passed down to the textarea element
}) => {
  ...
  return (
    <div className="relative">
      <textarea
        ...
        {...props} // Spread props like value, onChange, etc.
      />
      {hint && (
        <p
